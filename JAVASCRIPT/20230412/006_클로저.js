// 클로저
//폐쇠된 공간 안의 데이터에 접근하기 위한 테크닉으로, 이를 포함하고있는 외부함수의 변수에 접근할 수 있는 내부함수이다.
//폐쇠된 공간 안의 데이터에 접근하기 위한 테크닉입니다.
// 클로저는 외부함수(포함하고 있는)의 변수에 접근할 수 있는 내부 함수!!를 일컫습니다.
...
//newInner라는 변수를 통해서 접근할 수 있기때문에 휘발되지 않았다
var newInner = outer(); 
newInner();

...
함수['location'] = 'jeju'
//확인하면 로케이션이라는 벨류는 들어가져있음!!
// - 함수도 객체(object)에 해당한다 js는
...
함수(100, 200) //330
함수(100, 200, 300) //600
함수(c = 300) //330이 아니고 350이다!! a에 값이 들어간다!!

// 3. roro기법 원리 설명
// roro기법 - 입력되는 아규먼트가 매우 많은 함수의 경우 호출하는 쪽에서 어떤 값이 들어가는지 명확히 알기 어렵고 읽기도 어렵다.
const 중요변수 = hello('Title', 20, 30, 50, 60, 70, 100, 100, 200, 30, true)
//이렇게 하면 이해하기 어려울 것!
...
//roro 기법을 모든 함수에서 사용하나요? 아니오 짧으면 사용할 필요 x
function 함수(a, b) {
    return a + b
}
...
let {one1, two2, three3} = {one1:10, two:220, three3:30}
let {one1, two2, three3} = {two2:20, one1:10, three3:30}
//let {one1:10, two2, three3} = {two2:20, one1:10, three3:30} //error

let {one1=10, two2, three3} = {two2:20, three3:30} //처음 지정은 = 으로 set하기 
